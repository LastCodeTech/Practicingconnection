...
<body class='bg-gray-100'>
   ...
   <form action="includes/addTask.php" method="POST">
     <div class="flex flex-col justify-center items-center mt-20">
        <input name="title" type='text' value="<?php echo $result[0]['title']?>" class='h-10 w-80 md:w-120 border-1 mb-5 rounded-2xl'>
        <textarea name="description" class="mx-10 bg-white border-1 border-gray-400 outline-none h-50 w-80 md:w-120 rounded-2xl px-3 py-3 text-base md:text-xl text-gray-700 font-thin"><?php echo $result[0]['description']?></textarea>
